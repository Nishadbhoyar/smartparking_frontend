...
import { ClipboardList, Car, RefreshCw, KeyRound, X, Calendar } from "lucide-react";
...
const CarRentalBookingsPage = () => {
  ...
  const load = () => {
    setL(true);
    axiosInstance.get(`/api/rental-cars/owner/${user.id}/bookings`)
      .then((r) => setB(r.data || []))
      .catch(() => setB([]))
      .finally(() => setL(false));
  };
    ...
    <div className="page-container space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Bookings made on your listed cars</p>
        </div>
